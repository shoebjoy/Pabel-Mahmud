  ...
  return (
    <div className="container mx-auto px-4 lg:px-[100px] py-12">
      ...
      >
        ...
        <div className="bg-[#171717] rounded-xl p-6 text-[#E6E6E6] flex flex-col justify-between lg:col-span-5">
          <div>
            <h3 className="text-2xl font-semibold mb-1">HI-TECH Furniture</h3>
            <p className="text-xl font-medium mb-3">
              Video Editor & Graphic Designer
            </p>
            <p className="text-base leading-relaxed">
              Created promotional videos, product showcases, and motion graphics to enhance the brands digital presence and marketing campaigns.
            </p>
          </div>
